define(["require", "exports"], function (require, exports) {
    ...
    class World {
        ...
        neighbours(x, y) {
            ...
            if (n1)
                list.push({ hex: n1, xOff: 0, yOff: -1 });
            if (n2)
                list.push({ hex: n2, xOff: -1, yOff: 0 });
            if (n3)
                list.push({ hex: n3, xOff: 1, yOff: 0 });
            if (n4)
                list.push({ hex: n4, xOff: 0, yOff: 1 });
            if (n5)
                list.push({ hex: n5, xOff: -1, yOff: 1 });
            if (n6)
                list.push({ hex: n6, xOff: 1, yOff: 1 });
            return list;
        }
        findConnected(x, y) {
